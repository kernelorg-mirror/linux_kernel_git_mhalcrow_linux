...
extern int fsverity_enable(struct inode *inode, const struct fsverity_set *set);
...
extern loff_t fsverity_i_size(const struct inode *inode);
extern bool fsverity_page_in_metadata_region(const struct page *page);
